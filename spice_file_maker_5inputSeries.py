...
voltage = 0.1
for n in filenames:
    name_o_file = "PreLayout/noise_pulsegate5in_1p4nSeries"+n+".cir"
...
name_o_sh = "run_exp_noise_first_event_time_5input1p4nSeries.sh"
f = open(name_o_sh,"w")
n = 0
for a in filenames:
    n = 0
    while n < 50:
        f.write("ngspice -b -o noiseFirstStart1p4nSeries/data" +str(n) + a + ".txt "
                                                                        "PreLayout/noise_pulsegate5in_1p4nSeries"+a+".cir\n")
        n += 1