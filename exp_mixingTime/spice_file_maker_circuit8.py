...
std_dev = 0.1
voltage = 0.1
name_o_file = "PreLayout/exp_mixing_time_circuit8_"
for n in filenames:
...
name_o_sh = "run_exp_mixing_time_circuit8.sh"
f = open(name_o_sh,"w")
q = 0
for n in filenames:
    q = 0
    while q < 100:
        f.write("ngspice -b -o exp_mixingTime/circuit8/data" +str(q) + n + ".txt "+ name_o_file + n + ".cir\n")
        q += 1