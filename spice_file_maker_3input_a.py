...
voltage = 0.1
for n in filenames:
    name_o_file = "PreLayout/noise_pulsegate3in_1n2p"+n+".cir"
...
name_o_sh = "run_exp_noise_first_event_time_3input1p2n.sh"
f = open(name_o_sh,"w")
n = 0
for a in filenames:
    n = 0
    while n < 100:
        f.write("ngspice -b -o noiseFirstStart1p2n/data" +str(n) + a + ".txt PreLayout/noise_pulsegate3in_1n2p"+a+".cir\n")
        n += 1